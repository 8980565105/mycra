...
// ─────────────────────────────────────────────────────────
// fetchPages — Admin / Store Owner panel mate
// ─────────────────────────────────────────────────────────
export const fetchPages = createAsyncThunk(
  "pages/fetchPages",
  async (params = {}, { rejectWithValue }) => {
...
// ─────────────────────────────────────────────────────────
// fetchPageBySlug — Public frontend mate
// Domain header backend ne automatically jaay se
// Backend injectPublicStoreFilter thi storeId resolve kare se
// Pachi slug + storeId thi exact page return kare se
// ─────────────────────────────────────────────────────────
