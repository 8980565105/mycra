  ...
  return (
    <div className="relative w-full mx-auto">
      ...
      <section className="relative lg:ml-[50px] mt-4 mx-2 lg:mx-0 overflow-hidden rounded-lg">
        {heroSlides.length === 0 ? (
          <div className="w-full min-h-[220px] lg:min-h-[680px] bg-[#f5ebe3] flex items-center justify-center rounded-lg"></div>
        ) : (
              ...
              <div key={index}>
                ...
                >
                  ...
                  <div className="relative z-10 w-full h-full min-h-[220px] lg:min-h-[680px] flex items-center px-6 sm:px-12 lg:px-20 py-10 lg:py-0">
                    <div className="flex-1 flex flex-col items-start justify-center gap-3 lg:gap-6 max-w-[50%]  max-w-[250px] sm:max-w-[400px] lg:max-w-[600px]">
