...
export default function ProductInfo({
  ...
  // ✅ Reviews directly product.reviews thi aave
  // Backend getPublicProductById ma populate("reviews") kari didhu che
  // Koi alag fetchProductReviews API call nathi karvi
  const reviewData = useMemo(() => {
