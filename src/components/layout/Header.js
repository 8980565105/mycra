                      ...
                      {isMegaMenuOpen && (
                        ...
                        >
                          <div className="max-w-[1400px] mx-auto w-full flex">
                            <div className="w-1/4 border-r border-[var(--primary-color)] bg-white py-4">
                                ...
                                <div
                                  ...
                                  className={`px-6 py-3 cursor-pointer flex justify-between items-center transition-colors ${
                                    activeParent === parent._id
                                      ? "bg-gray-100 text-[var(--theme-color)] font-bold"
                                      : "text-[var(--secondary-color)] hover:bg-white"
                                  }`}
                                >
                                ...
                                <>
                                  <div className="flex justify-between items-center">
                                    ...
                                    <Button
                                      ...
                                      className="text-[var(--secondary-color)] transition-colors hover:text-[var(--primary-color)] hover:underline"
                                    >
                                      All SubCategories
                                    </Button>
                                  </div>
                                          ...
                                          {paginated.length > 0 ? (
                                            paginated.map((sub) => (
                                              ...
                                              >
                                                ...
                                                <p className="mt-2 text-sm text-[var(--secondary-color)] group-hover:text-[var(--theme-color)]">
                                                  {sub.name}
                                                </p>
                                              </div>
                                            ))
          ...
          <div className="relative hidden custom-lg:block group">
            ...
            <div className="absolute right-0 mt-2 w-[280px] bg-white rounded-[10px] form-shadow z-50 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300">
              <div className="p-[17px] text-light text-p flex justify-between border-b border-[#989696]">
                {!token ? (
                  <>
                    ...
                    <span
                      className="text-[var(--secondary-color)] hover:text-[var(--primary-color)] cursor-pointer font-18 font-medium"
              ...
              <ul className="text-light text-p p-[17px]">
                <li className="py-[10px] text-[var(--secondary-color)] hover:text-[var(--primary-color)]">
                  <button
                ...
                <li className="py-[8px] text-[var(--secondary-color)] hover:text-[var(--primary-color)]">
                  <button
