...
// const CustomBarTooltip = ({ active, payload }: any) => {
//   if (active && payload && payload.length) {
//     const { name, sales, revenue, storeName } = payload[0].payload;
//     return (
...
//         {storeName && (
//           <div className="text-muted-foreground mb-1">Store: {storeName}</div>
//         )}
//         <div className="flex items-center justify-between gap-4">
//           <span className="text-muted-foreground">Qty sold</span>
//           <span className="font-mono font-medium">{sales}</span>
//         </div>
//         <div className="flex items-center justify-between gap-4">
...
export default function VelzonDashboard() {
  ...
  // const topProductsData = topSellingProducts.map((product, index) => ({
  //   name: product.name,
  //   sales: product.quantity,
  //   revenue: product.revenue || 0,
              ...
              <ChartContainer config={chartConfig} className="h-[400px]">
                <BarChart data={topProductsData} layout="horizontal">
                  ...
                  <YAxis
                    ...
                    tickLine={false}
                  />
                  <ChartTooltip content={<CustomBarTooltip />} cursor={{ fill: "hsl(var(--muted)/0.3)" }} />
