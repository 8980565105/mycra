...
export default function Wallets() {
  ...
  const quickAdd = (val) => setAmount((prev) => (Number(prev) || 0) + val);
        ...
        <div className="flex flex-col lg:flex-row gap-4 max-w-6xl">
          <div className="flex-1 space-y-4">
            <div className="bg-white rounded-lg shadow-sm">
              <div className="flex justify-between items-center px-5 py-4 border-b border-dashed border-gray-300">
            ...
            <div className="bg-white rounded-lg shadow-sm p-5">
              ...
              {!isKycVerified && (
                <>
                  <label className="block text-xs text-gray-500 border border-gray-300 rounded-md px-3 pt-1 pb-2 mb-3 w-full max-w-xs">
                    Enter Amount
            ...
            <div className="bg-white rounded-lg shadow-sm p-3 flex items-center gap-3 max-w-md">
